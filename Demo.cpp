...
int main()
{
  ...
  cout <<"p1 stack size: "<< p1.stacksize() << endl;   // prints the amount of cards left. should be 21 but can be less if a draw was played
  cout << "p2 cards taken: "<< p2.cardesTaken() << endl; // prints the amount of cards this player has won.
